...
"use strict";
module.exports = JSON.parse('{"Validator":{"requiredOptions":["files","from"],"checkTypes":[{"optionName":"files","checks":["isArray","isString"]},{"optionName":"from","checks":["isRegExp","isString"]},{"optionName":"optionsForFiles","checks":["isObject"]},{"optionName":"to","checks":["isFunction","isString"]},{"optionName":"defaultEncoding","checks":["isString","isNull"]},{"optionName":"onlyFindPathsWithoutReplace","checks":["isBoolean"]},{"optionName":"replaceFileOnlyIfMatchRegxpInFile","checks":["isRegExp","isString"]},{"optionName":"saveOldFile","checks":["isBoolean"]}]},"Configurator":{"defaultEncoding":"utf8","defaultReturnCountOfMatchesByPaths":true,"shouldSkipBinaryFiles":true,"defaultReturnPaths":true,"defaultReplaceInFilesOptions":true,"defaultSaveOldFile":false,"defaultOnlyFindPathsWithoutReplace":false,"defaultOptionsForFiles":{"ignore":["**/node_modules/**"]}}}');
...
const replaceInFiles = __nccwpck_require__(3853);
...
const path = __nccwpck_require__(5622);
const pathType = __nccwpck_require__(8373);
...
var reusify = __nccwpck_require__(9124)
...
const fs = __nccwpck_require__(5747);
const path = __nccwpck_require__(5622);
const fastGlob = __nccwpck_require__(1696);
const gitIgnore = __nccwpck_require__(9970);
const slash = __nccwpck_require__(8868);
...
const fs = __nccwpck_require__(5747);
const arrayUnion = __nccwpck_require__(2878);
const merge2 = __nccwpck_require__(5919);
const fastGlob = __nccwpck_require__(1696);
const dirGlob = __nccwpck_require__(720);
const gitignore = __nccwpck_require__(1889);
const {FilterStream, UniqueStream} = __nccwpck_require__(6629);
...
module.exports = __nccwpck_require__(1881);
...
const _ = __nccwpck_require__(5817);
const config = __nccwpck_require__(8818);
...
const _ = __nccwpck_require__(5817);
const helpers = __nccwpck_require__(3497);
const { FIND_MATCHES } = __nccwpck_require__(7013);
...
const _ = __nccwpck_require__(5817);
const helpers = __nccwpck_require__(3497);
const { CHANGE_FILE } = __nccwpck_require__(7013);
...
const _ = __nccwpck_require__(5817);
const globby = __nccwpck_require__(8104);
const isBinary = __nccwpck_require__(6091);

const Validator = __nccwpck_require__(8679);
const Configurator = __nccwpck_require__(3131);
const Finder = __nccwpck_require__(1332);
const Patcher = __nccwpck_require__(9003);
const Logger = __nccwpck_require__(7430);
const DateFormatter = __nccwpck_require__(8307);
const helpers = __nccwpck_require__(3497);
...
const co = __nccwpck_require__(6735);
const fs = __nccwpck_require__(5747);
const { promisify } = __nccwpck_require__(7000);
const { EventEmitter } = __nccwpck_require__(8614);

const { ADD_REPLACE_IN_FILES_OPTIONS } = __nccwpck_require__(7013);
...
const helpers = __nccwpck_require__(3497);
const ReplaceInFiles = __nccwpck_require__(4523);
